...
$(document).ready(function() {
	...
	$("button").click(function(event) {
		...
		// 3. A function that will be triggered as soon as the request is
		// successful.
		// Optionally, you can also chain a method that will handle the
		// possibility
		// of a failed request.
		$.get('ItemServlet', {
			"button-id" : buttonID
			...
			if (buttonID === "moreButton") {
				alert("My button lciejfgnjagjn");
				printMore(resp);
				window.alert("Im after Print More");
			}// to come
				// toknsfdjkndjknsfjknfdfdjnkdjndfjnkdfsjndsfjndsnjnjdsjnksdfnjk
			else if (buttonID === "commentButton")

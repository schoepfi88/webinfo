...
<div class="row">
	...
	<div class="col-xs-10 col-md-10 col-sm-10 col-lg-10">
		<div id="feedback" class="alert alert-success" role="alert">
			<%
				out.println(Resource.getFeedback());
			%>
		</div>
	</div>
</div>
	...
	<div ng-controller="ItemCtrl">
		...
		<div ng-show="oneSelected">
			...
			<div class="row">
				...
				<div class="col-xs-10 col-md-10 col-sm-10 col-lg-10">
					...
					<div class="panel panel-default" ng-repeat="comment in comments">
						<div class="panel-body">
							{{comment.author}} : {{comment.message}} <span class="author">
					...
					<form class="form-group" id="commentForm" method="POST">
						<label for="author">Author</label> <input class="form-control"
							ng-model="comment.author" name="author" /> <br> <label
							for="title1">Title</label> <input class="form-control"
							ng-model="comment.title1" name="title1" /> <br> <label
							for="message">Message</label>
						<textarea class="form-control" ng-model="comment.message"
							name="message" rows="3"></textarea>
						<br> <input class="btn btn-default"
							ng-click="createComment(comment)" type="submit" value="Submit" />
					</form>
				</div>
			</div>
			<div class="row" ng-show="created">
				<div class="col-xs-1 col-md-1 col-sm-1 col-lg-1"></div>
				<div class="col-xs-10 col-md-10 col-sm-10 col-lg-10">
					<div id="feedback" class="alert alert-success" role="alert">Comment
